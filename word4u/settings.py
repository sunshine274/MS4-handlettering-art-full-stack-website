...
ALLOWED_HOSTS = ['ms4-lettering-design-e-shop.herokuapp.com', 'localhost']
...
if 'USE_AWS' in os.environ:
    ...
    STATIC_URL = f'https://{AWS_S3_CUSTOME_DOMAIN}/{STATICFILES_LOCATION}/'
    MEDIA_URL = f'https://{AWS_S3_CUSTOME_DOMAIN}/{MEDIAFILES_LOCATION}/'
